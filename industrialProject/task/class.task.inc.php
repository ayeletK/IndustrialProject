    ...
    public function AddGenericTask()
    {
        ...
        if ($_SERVER["REQUEST_METHOD"] == "POST") {
            ...
            if (!($data_correct == 0) && empty($_POST["task_id"])) {
                ...
                if (!preg_match("/^[a-zA-Z0-9_\-]{4:18}$/",$task_id)) {
                    $data_correct = 0;
                }
                $query = "SELECT count(*) From `Tasks` WHERE ".__task_tl_task_id." LIKE '$task_id' ";
            ...
            //====================================================
            //	check validation of "$instruction" input
            //====================================================            
            ...
            if (empty($_POST["account_name"])) {
                ...
                if (!preg_match("/^[a-zA-Z0-9_\-]{4:30}$/",$account_name)) {
                    $data_correct = 0;
                }
            }//close the else
            ...
            if (empty($_POST["schedule_id"])) {
                ...
                if (!preg_match("/^[a-zA-Z0-9_\-]{4:30}$/",$schedule_id)) {
                    $data_correct = 0;
                }
            }//close the else 
